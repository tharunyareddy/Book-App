...
public class BookImpl implements BookInter {
	...
	public boolean deleteBook(int bookid) throws BookNotFoundException {
		...
		PreparedStatement st = null;
		try {
			st = connection.prepareStatement(deleteQuery, ResultSet.CONCUR_UPDATABLE, ResultSet.TYPE_SCROLL_INSENSITIVE);
			st.setInt(1, bookid);
			st.execute();
		} catch (SQLException e) {
	...
	public Book getBookById(int bookid) throws BookNotFoundException {
		...
		Book book = new Book();
		try {
			st = connection.prepareStatement(idSelectQuery, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
			st.setInt(1, bookid);
	...
	public int updateBook(int bookid, double price) {
		...
		try {
			...
			connection = ModelDao.openConnection();
			st = connection.prepareStatement(updateQuery, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
			st.setInt(2, bookid);
	...
	public List<Book> getAllBooks() {
		...
		try {
			...
			st = connection.prepareStatement(allselectQuery, ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
			ResultSet rs = st.executeQuery();
			while (rs.next()) {
				book.setTitle(rs.getString(1));
				book.setAuthor(rs.getString(2));
	...
	@Override
	public List<Book> getBookByPrice(double bookPrice) throws BookNotFoundException {
